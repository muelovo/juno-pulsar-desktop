...
PNG assets must use 8-bit channels. Compressed ancillary profiles/text, arbitrary metadata chunks and trailing data are rejected; export as a plain PNG sprite sheet.
